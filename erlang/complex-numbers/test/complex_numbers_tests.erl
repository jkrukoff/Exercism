...
not_equal_imaginary_test() ->
    ?assertNot(complex_numbers:equal(complex_numbers:new(1, 1), complex_numbers:new(1, 2))).

not_equal_real_test() ->
    ?assertNot(complex_numbers:equal(complex_numbers:new(1, 1), complex_numbers:new(2, 1))).

not_equal_both_test() ->
    ?assertNot(complex_numbers:equal(complex_numbers:new(1, 1), complex_numbers:new(2, 2))).
